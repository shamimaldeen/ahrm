    ...
    <div class="portlet light">
      <div class="portlet-title">
        <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase" id="hidden_table_title">Aproved Provident Refund</span>
        </div>
        ...
        <table class="table table-bordered table-striped table-hover" id="sample_3">
          ...
          <?php $c++ ?>
            <tr id="tr-{{$refund->id}}">
              ...
              <td>
                <a class="btn btn-xs btn-success" onclick="Withdraw('{{$refund->id}}')">Withdraw</a>
              </td>
            </tr>
          @endforeach
          @endif
