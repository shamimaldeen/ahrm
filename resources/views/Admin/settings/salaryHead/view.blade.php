        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase" id="hidden_table_title">Salary Head Information</span>
                </div>

                <div class="col-md-6"><p id="confirm_msg"></p></div>
                
                <div class="actions">
                  <a href="{{url('salary-head/create')}}" class="btn btn-success btn-sm" style="margin: 5px;"><i class="fa fa-plus"></i>&nbsp;Add New</a>
                    <div class="btn-group">
              ...
              {{ csrf_field() }}
               <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                          ...
                          <th>Taxable</th>
                          <th>Tax Exemption Amount (Yeaqrly)</th>
                          <th>Salary Head Note</th>
                          <th>Status</th>
                          <th>Action</th>
                        </tr>
                      </thead>
                      ...
                      @endphp
                        ...
                        @endphp
                         <tr id="tr-{{$hd->head_id }}">
                            ...
                            <td>{{$hd->head_percentage}} %</td>
                            <td>
                            @if($hd->head_taxable=="1")
                              <a class="btn btn-xs btn-danger">Yes</a>
                            @elseif($hd->head_taxable=="0")
                              <a class="btn btn-xs btn-success">No</a>
                            @endif
                            </td>
                            <td>{{$hd->head_taxexempt}}</td>
                            <td>{{$hd->head_note}}</td>
                            <td>
                            @if($hd->head_status=="1")
                            ...
                            <td>
                              <a class="btn btn-xs btn-success" href="{{url('salary-head')}}/{{$hd->head_id }}/edit">Edit</a>
