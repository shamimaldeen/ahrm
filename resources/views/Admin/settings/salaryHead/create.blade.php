        ...
        <div class="col-md-12">
          ...
          <div class="portlet box grey-cascade">
            <div class="portlet-title">
              <div class="caption">
                <i class="fa fa-globe"></i>Add Salary Head
              </div>
            ...
            <div class="portlet-body">
              ...
              <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{route('salary-head.store')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
              {{ csrf_field() }}
              ...
              <div class="form-group" hidden="">
               ...
               <div class="form-group" hidden="">
                ...
                <div class="col-md-8">
                    <input type="radio" name="other_head_type" value="1">&nbsp;On
                    &nbsp;&nbsp;
                    <input type="radio" name="other_head_type" value="0" checked="">&nbsp;Off
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" name="head_percentage" value="{{old('head_percentage')}}" class="form-control">
                </div>
              ...
              <div class="form-group" id="head_taxexempt" style="display: none">
                ...
                <div class="col-md-8">
                  <input type="number" name="head_taxexempt" value="0" min="0" class="form-control">
                </div>
