...
<div class="row" style='padding: 30px; background-color: #f7f7f7; margin: 0px;'>
  ...
  <div class="form-group">
    <div class="col-md-6 col-md-offset-3">
     <span id="hidden_table_title" style="display: none;">Shift Wise Employee Summery @if(isset($start_date) && isset($end_date)) Joining Date From {{$start_date}} to {{$end_date}} 
      @endif</span>
    </div>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Shift Wise Employee Summary @if(isset($start_date) && isset($end_date))( {{$start_date}} to {{$end_date}} )@endif</span>
                </div>
...
function getFilter() {
  ...
  if(emp_depart_id>0 || emp_sdepart_id>0 || emp_desig_id>0 || emp_jlid>0 || emp_type>0){
    window.open("{{URL::to('shift-wise-employee-summary')}}/"+emp_depart_id+"/"+emp_sdepart_id+"/"+emp_desig_id+"/"+emp_jlid+"/"+emp_type+"/search","_parent");
  }else{
