        ...
        <table class="table table-striped" style="border:0px">
          ...
          @php
            ...
            <tr>
              ...
              <td class="strong-text">Baishakhy Bonus</td>
              <td class="text-right strong-text">{{$PayrollSummery->b_bonus}} BDT</td>
            ...
            <tr>
              ...
              <td class="strong-text">Eid-Ul-Fitr</td>
              <td class="text-right strong-text">{{$PayrollSummery->fitr_bonus}} BDT</td>
            ...
            <tr>
              ...
              <td class="strong-text">Eid-Ul-Adha</td>
              <td class="text-right strong-text">{{$PayrollSummery->adha_bonus}} BDT</td>
