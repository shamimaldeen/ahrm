      ...
      <div class="portlet light bordered">
          ...
          <div class="portlet-body">
            ...
            <div class="row" style='padding: 30px; background-color: #fff; margin: 0px;'>
              <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ route('payroll-delete-submit') }}" name="basic_validate" id="basic_validate" novalidate="novalidate">
              {{ csrf_field() }}
