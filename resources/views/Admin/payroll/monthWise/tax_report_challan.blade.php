        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Month Wise Tax Challan</span>
                </div>
            </div>
            <div class="portlet-body">
              <!-- filter start -->
              <div class="row" style='padding: 30px; background-color: #f7f7f7; margin: 0px;'>
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('generate-tax-report-challan-submit')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <input type="submit" class="btn btn-success btn-block" value="Generate Challan">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="portlet light bordered">
                    ...
                    <div class="portlet-body table-responsive">
                      <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('month-wise-taxchallan-save')}}" id="data_form">
                      {{ csrf_field() }}
                          ...
                          <thead>
                            <tr>
                              ...
                              @endif -->
                               ...
                               <th class="col-md-1 text-success">Tax Challan Number</th>
