        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Month Wise Bonus Generate</span>
                </div>
            </div>
            <div class="portlet-body">
              <!-- filter start -->
              <div class="row" style='padding: 30px; background-color: #f7f7f7; margin: 0px;'>
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('generate-month-wise-bonus-submit')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <select name="bonus_type" class="form-control chosen">
                     
                      @if($bonus_type==1)
                  
                      <option value="1" selected="">Baishakhy Bonus</option>
                      <option value="2">Eid-Ul-Fitr Bonus</option>
                      <option value="3">Eid-Ul-Adha Bonus</option>
                       @elseif($bonus_type==2)
                  
                      <option value="1">Baishakhy Bonus</option>
                      <option value="2" selected="">Eid-Ul-Fitr Bonus</option>
                      <option value="3">Eid-Ul-Adha Bonus</option>
                       @elseif($bonus_type==3)
                  
                      <option value="1">Baishakhy Bonus</option>
                      <option value="2">Eid-Ul-Fitr Bonus</option>
                      <option value="3" selected="">Eid-Ul-Adha Bonus</option>
                      @elseif($bonus_type==0)
                       <option value="1">Baishakhy Bonus</option>
                      <option value="2">Eid-Ul-Fitr Bonus</option>
                      <option value="3">Eid-Ul-Adha Bonus</option>
                  ...
                  <div class="col-md-3">
                    <input type="submit" class="btn btn-success btn-block" value="Generate Bonus">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="portlet light bordered">
                    ...
                    <div class="portlet-body table-responsive">
                      <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('month-wise-bonus-save')}}" id="data_form">
                      {{ csrf_field() }}
                       ...
                       <table class="table table-striped table-bordered table-hover">
                          <thead>
                            <tr>
                              ...
                              @if($bonus_type==1)
                               <th class="col-md-1 text-success">Baishakhy Bonus (BDT)</th>
                              @elseif($bonus_type==2)
                              <th class="col-md-1 text-success">Eid-Ul-Fitr Bonus (BDT)</th>
                              @elseif($bonus_type==3)
                              <th class="col-md-1 text-success">Eid-Ul-Adha Bonus (BDT)</th>
                              @endif
                               ...
                               <!--  @if(isset($SalaryHeadExtendsAddition) && count($SalaryHeadExtendsAddition))
                                ...
                                <!-- <td>
                                 ...
                                 <td class="text-right text-{{(($payroll['addition']>=0) ? 'success' : 'danger')}}">
                                  ...
                                  @if($bonus_type==1)
                                  <input type="number" name="b_bonus[{{$payroll['emp_id']}}]" id="addition-field-{{$payroll['emp_id']}}" value="{{ $payroll['baishakhy_bonus'] }}" class="form-control text-left " readonly="">
                                  @elseif($bonus_type==2)
                                  <input type="number" name="fitr_bonus[{{$payroll['emp_id']}}]" id="addition-field-{{$payroll['emp_id']}}" value="{{ $payroll['fitr_bonus'] }}" class="form-control text-left " readonly="">
                                  @elseif($bonus_type==3)
                                  <input type="number" name="adha_bonus[{{$payroll['emp_id']}}]" id="addition-field-{{$payroll['emp_id']}}" value="{{ $payroll['adha_bonus'] }}" class="form-control text-left " readonly="">
                                  @endif
                                </td>
