                  ...
                  <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                      <div class="col-md-6">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('bank-cash-print')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        {{ csrf_field() }}
