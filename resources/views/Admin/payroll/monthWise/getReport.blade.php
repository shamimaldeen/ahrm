        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Bank & Cash Payments Report</span>
                </div>
            </div>
              ...
              <div class="row" style='padding: 30px; background-color: #f7f7f7; margin: 0px;'>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4 col-md-offset-4 text-center">
                    <button type="button" class="btn btn-primary" onclick="window.open('{{url('month-wise-bank-and-cash-payments-report')}}/'+$('#type').val()+'/'+$('#report').val()+'/'+$('#month').val()+'/'+$('#year').val(),'_blank')"><i class="fa fa-print"></i>&nbsp;Print Report</button>
                  </div>
                </div>
                </form>
              </div>
