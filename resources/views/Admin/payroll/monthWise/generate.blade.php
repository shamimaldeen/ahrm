        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                   ...
                   <span style="float: right;"> <a  href="{{ route('generated-payroll-list') }}"> (View Generated Payroll List)</a></span>
                </div>
            </div>
            <div class="portlet-body">
              <!-- filter start -->
              <div class="row" style='padding: 30px; background-color: #f7f7f7; margin: 0px;'>
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('generate-month-wise-payroll-submit')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                {{ csrf_field() }}
                ...
                <div class="col-md-12">
                  <div class="portlet light bordered">
                    ...
                    <div class="portlet-body table-responsive">
                      <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('month-wise-payroll-save')}}" id="data_form">
                      {{ csrf_field() }}
                            ...
                            <tr>
                              ...
                              @endif
                               ...
                               @php
                                ...
                                @if(isset($b))
                               <th class="col-md-1 text-success">Baishakhay Bonus (BDT)</th>
                               @endif
                               @php
                                ...
                                @if(isset($c))
                               <th class="col-md-1 text-success">Eid-Ul-Fitr (BDT)</th>
                               @endif
                                @php
                                ...
                                @if(isset($d))
                               <th class="col-md-1 text-success">Eid-Ul-Adha (BDT)</th>
                               @endif

                               <th class="col-md-1 text-success">Total Taka (BDT)</th>
                            ...
                            <input type="hidden" name="perDaySalary[{{$payroll['emp_id']}}]" value="{{$payroll['perDaySalary']}}">
                              <tr>
                                ...
                                <td>
                                  ...
                                  <input type="text" name="b_bonus[{{$payroll['emp_id']}}]" value="{{ $payroll['baishakhy_bonus'] }}" class="form-control text-right text-success">
                                </td>
                                @endif
                                @php
                                    $c=App\Setup::where('fitr_bonus','>',0)->first();
                                ...
                                @if(isset($c))
                                <td>
                                  <input type="text" name="fitr_bonus[{{$payroll['emp_id']}}]" value="{{ $payroll['fitr_bonus'] }}" class="form-control text-right text-success" onkeyup="">
                                </td>
                                @endif
                                ...
                                @if(isset($d))
                                <td>
                                  <input type="text" name="adha_bonus[{{$payroll['emp_id']}}]" value="{{ $payroll['adha_bonus'] }}" class="form-control text-right text-success" onkeyup="">
                                </td>
                                @endif

                                 <td class="text-right text-{{(($payroll['addition']>=0) ? 'success' : 'danger')}}">
                                  <span id="addition-{{$payroll['emp_id']}}">{{$payroll['addition']}}</span>
                                  <input type="hidden" name="addition[{{$payroll['emp_id']}}]" id="addition-field-{{$payroll['emp_id']}}" value="{{$payroll['addition']}}">
                                </td>
                                ...
                                <td>
                                  ...
                                  <input type="text" name="mobilebill[{{$payroll['emp_id']}}]" value="{{ $payroll['emp_mobilebill'] - $payroll['emp_allocamount']}} "class="form-control text-right text-danger" onkeyup="calculate('{{$payroll['emp_id']}}')">
                                  @else
                                  <input type="text" name="mobilebill[{{$payroll['emp_id']}}]" value="0"class="form-control text-right text-danger" onkeyup="calculate('{{$payroll['emp_id']}}')">
                                  @endif
