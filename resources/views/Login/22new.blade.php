                    ...
                    <div class="login-bg" style="background: #821745; position: relative; z-index: 0;">
                        <div class="row" style="height: 280px">
                            <div class="col-md-10 col-md-offset-1 text-center">
                                <img src="{{url('public/projectDetails')}}/{{$project->project_logo}}" style="margin: 280px 0px 0px">
                            </div>
                        </div>
                        <div class="row" style="vertical-align: middle;height: 500px">
                            <div class="col-md-10 col-md-offset-1 text-center">
                                ...
                                <h4 style="color: white">
                                    <div><p style="font-size: 15px;">Copyright &copy; Acquaint Technologies 2021</p>
                                    </div>
                                </h4>
                            </div>
                        </div>
